  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        notFound:   resolve(__dirname, 'demo/404.html'),
        viMain:       resolve(__dirname, 'demo/vi/index.html'),
        viDocs:       resolve(__dirname, 'demo/vi/docs.html'),
        viPlayground: resolve(__dirname, 'demo/vi/playground.html'),
      },
    },
  },
  css: {
